...
import { ChevronLeft, ChevronRight, X, Home, LayoutDashboard, Languages, Sparkles, Briefcase, PlusSquare, History, Heart, Users, AlertTriangle, User, Settings, CheckCircle2, Store } from 'lucide-react';
...
const STEPS = [
    ...
    { title: 'Nearby Shops', description: 'Browse approved shops and see automatic material discounts.', howItWorks: 'Open this section to view live locations, contact details, and product previews.', selector: '[data-guide-id="client-page-nearby-shops"]', route: '/client/nearby-shops', icon: Store },
