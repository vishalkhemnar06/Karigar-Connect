...
import { getImageUrl, getDirectInvites, acceptDirectInvite, rejectDirectInvite } from '../../api/index';
                                ...
                                {filtered.map((invite) => (
                                    ...
                                    >
                                        ...
                                        <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 mb-2">
                                            ...
                                            <div className="flex items-center gap-1 text-[11px] text-gray-600">
                                                <Users size={11} /> {invite.workersRequired}
                                            </div>
                                            <div className="flex items-center gap-1 text-[11px] text-gray-600">
                                                <Calendar size={11} /> {new Date(invite.invitedAt).toLocaleDateString()}
                                            </div>
                                        </div>
                                ...
                                <div className="space-y-2 mb-4">
                                    <div className="flex items-start gap-2">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-xs font-semibold text-gray-800">{selectedInvite.location?.city || 'Not specified'}</p>
                                        </div>
                                    </div>
                                    ...
                                    {selectedInvite.skills?.length > 0 && (
                                        <div>
                                            <p className="text-[11px] text-gray-500 mb-1.5">Required Skills</p>
                                            <div className="flex flex-wrap gap-1">
                                                {selectedInvite.skills.map((skill) => (
                                                    <span
                                                        key={skill}
                                                        className="px-2 py-0.5 bg-purple-50 text-purple-700 rounded-lg text-[10px] font-semibold border border-purple-100 capitalize"
                                                    >
                                                        {skill}
                                                    </span>
                                                ))}
