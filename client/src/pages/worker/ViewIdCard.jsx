...
const ViewIdCard = () => {
    ...
    const downloadPDF = async () => {
        ...
        try {
            ...
            pdf.save(`KarigarConnect_ID_${user.karigarId}.pdf`);
    ...
    // Derived data
    const photoUrl = !user.photo ? `https://ui-avatars.com/api/?name=${encodeURIComponent(user.name)}&background=ea580c&color=fff&bold=true&size=200`
    ...
    return (
        <div style={{
            ...
            <div style={{ textAlign:'center', marginBottom:'2rem' }}>
                <h1 style={{ color:'#f59e0b', fontFamily:'Bebas Neue, sans-serif', fontSize:28, letterSpacing:6, margin:0 }}>
                    KARIGARCONNECT
                </h1>
                <p style={{ color:'#64748b', fontSize:13, marginTop:4, letterSpacing:3, textTransform:'uppercase' }}>
            ...
            <p style={{ marginTop:12, fontSize:12, color:'#374151', letterSpacing:1, textTransform:'uppercase' }}>
